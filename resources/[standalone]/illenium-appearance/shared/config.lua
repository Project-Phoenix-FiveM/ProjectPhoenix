...
Config.Stores = {
    ...
    {
        type = "surgeon",
        coords = vector4(314.32, -568.74, 43.28, 158.68),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(311.36, -570.53, 43.28),
            vector3(315.08, -571.97, 43.28),
            vector3(316.57, -567.53, 43.28),
            vector3(313.59, -565.98, 43.28)
        }
    }
}
...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(458.85, -997.7, 30.69, 86.31),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(458.68991088867, -995.27294921875, 30.69),
            vector3(456.86697387695, -997.05883789062, 30.69),
            vector3(456.9543762207, -1000.3672485352, 30.69),
            vector3(464.11047363281, -999.91662597656, 30.69),
            vector3(464.19430541992, -995.560546875, 30.69),
            vector3(459.87838745117, -998.99194335938, 30.69)
        }
    }
}  
