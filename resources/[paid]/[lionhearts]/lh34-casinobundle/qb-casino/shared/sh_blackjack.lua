...
tables = {
	{
		coords = vector4(1027.855, 40.0838, 68.86, 100.97),
		highStakes = true
	},
	{
		coords = vector4(1033.817, 41.512, 68.86, 278.37),
		highStakes = true
	},
	{
		coords = vector4(1023.019, 60.771, 68.860, 102.45),
		highStakes = true
	},
	{
		coords = vector4(1028.989, 62.169, 68.860, 282.45),
		highStakes = true
	},
	{
		coords = vector4(1036.81, 50.90, 68.06, 9.43),
		highStakes = false
	},
	{
		coords = vector4(1035.850, 55.02, 68.06, 192.15),
		highStakes = false
	},
	{
		coords = vector4(1044.39, 52.66, 68.06, 13.45),
		highStakes = false
	},
	{
		coords = vector4(1043.42, 56.79, 68.06, 187.37),
		highStakes = false
	}
}
...
bettingNums = {
    ...
    100000,
    250000,
    500000 -- You can add extra amounts here for the high limit tables
}
