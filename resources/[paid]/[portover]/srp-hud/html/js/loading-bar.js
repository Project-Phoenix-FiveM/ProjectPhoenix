...
function _typeof(t) {
    ...
    "function" == typeof define && define.amd ? define([], e) : "object" === ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = e() : t.CircleProgress = e()
        ...
        function r(t) {
            switch (t.nodeType) {
                case 1:
                    return function (t) {
                        var e = "";
                        e += "<" + t.tagName, t.hasAttributes() && [].forEach.call(t.attributes, function (t) {
                            e += " " + t.name + '="' + t.value + '"'
                        });
                        e += ">", t.hasChildNodes() && [].forEach.call(t.childNodes, function (t) {
                            e += r(t)
                        });
                        return e += "</" + t.tagName + ">"
                    }(t);
    ...
    function u(t, n, i, a, s) {
        var o, h = "string" == typeof t ? u.easings[t] : t;
    ...
    var t, s, a, o, l, e, i = (t = function (t, e, r, n) {
        var i, a;
        if (n = n || document, a = Object.create(s), "string" == typeof t && (t = n.querySelector(t)), t) return (i = n.createElementNS("http://www.w3.org/2000/svg", "svg")).setAttribute("version", "1.1"), e && i.setAttribute("width", e), r && i.setAttribute("height", r), e && r && i.setAttribute("viewBox", "0 0 " + e + " " + r), t.appendChild(i), a.svg = i, a
    }, s = {
    ...
    return u.easings = {
        ...
        function a(t) {
            ...
            if (_classCallCheck(this, a), "string" == typeof t && (t = n.querySelector(t)), !t) throw new Error("CircleProgress: you must pass the container element as the first argument");
            if (t.circleProgress) return t.circleProgress;
            (t.circleProgress = this).doc = n, t.setAttribute("role", "progressbar"), this.el = t, r = _objectSpread(_objectSpread({}, a.defaults), r), Object.defineProperty(this, "_attrs", {
                value: {},
                enumerable: !1
            }), e = "valueOnCircle" === r.textFormat ? 16 : 8, this.graph = {
                paper: i(t, 100, 100),
                angle: 0
            }, this.graph.paper.svg.setAttribute("class", "circle-progress"+ ++svgvalue), this.graph.circle = this.graph.paper.element("circle").attr({
                class: "circle-progress-circle"+svgvalue,
                cx: 50,
                cy: 50,
                r: 50 - e / 2,
                fill: "none",
                ...
                class: "circle-progress-value"+svgvalue,
                fill: "none",
                stroke: "#00E699",
                "stroke-width": e
            }), this.graph.text = this.graph.paper.element("text", {
                class: "circle-progress-text"+svgvalue,
                x: 50,
                y: 50,
                font: "16px Arial, sans-serif",
                "text-anchor": "middle",
                fill: "#999"
            }), this._initText(), this.attr(["indeterminateText", "textFormat", "startAngle", "clockwise", "animation", "animationDuration", "constrain", "min", "max", "value"].filter(function (t) {
                return t in r
            }).map(function (t) {
                return [t, r[t]]
            }))
        ...
        return _createClass(a, [{
            ...
            value: function (t, e) {
                switch (t) {
                    ...
                    case "animation":
                        ...
                        if ("string" == typeof e && "none" !== e && !u.easings[e]) throw new Error('Failed to set "animation" on CircleProgress: the provided value '.concat(e, " is not a legal easing function name."))
                }
                return e
            }
        }, {
            ...
            value: function () {
                var t;
                return this._isIndeterminate() ? 0 : 0 === this.max ? this.value ? 360 : 0 : (t = (this.value - this.min) / this.max * 360, Math.min(360, Math.max(0, t)))
            }
        }, {
            ...
            value: function () {
                ...
                this._isIndeterminate() ? "valueOnCircle" === this.textFormat && this._positionValueText(i) : (t = this._valToAngle(this.value), e = this._getRadius(), r = this.clockwise, this.graph.circle.attr("r", e), "none" !== this.animation && t !== this.graph.angle ? u(this.animation, this.graph.angle, t - this.graph.angle, this.animationDuration, function (t) {
                    n.graph.sector.attr("d", a._makeSectorPath(50, 50, e, i, t, r))
                }) : this.graph.sector.attr("d", a._makeSectorPath(50, 50, e, i, t, r)), this.graph.angle = t, "valueOnCircle" === this.textFormat && this._positionValueText((2 * i + t) / 2)), "function" == typeof this.textFormat ? this.graph.text.content(this.textFormat(this.value, this.max)) : "value" === this.textFormat ? this.graph.text.el.textContent = void 0 !== this.value ? this.value : this.indeterminateText : "percent" === this.textFormat ? this.graph.text.el.textContent = (void 0 !== this.value && null != this.max ? Math.round(this.value / this.max * 100) : this.indeterminateText) + "%" : "none" === this.textFormat ? this.graph.text.el.textContent = "" : (this.graph.textVal.el.textContent = void 0 !== this.value ? this.value : this.indeterminateText, this.graph.textMax.el.textContent = void 0 !== this.max ? this.max : this.indeterminateText)
            }
        }, {
            key: "_getRadius",
            value: function () {
            ...
            value: function (t, e, r, n, i, a) {
                ...
                var s = n + i * (2 * (a = !!a) - 1),
                    ...
                    u = t + o.x,
                    c = t + h.x;
                return ["M", u, e + o.y, "A", r, r, 0, +(180 < i), +a, c, e + h.y].join(" ")
            }
        }]), a
    }()).defaults = {
        startAngle: 0,
