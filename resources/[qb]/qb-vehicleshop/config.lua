...
Config.Shops = {
    ['pdm'] = {
        ...
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(-49.98, -1083.96, 26.27, 201.21), -- where the vehicle will spawn on display
            ...
            [2] = {
                coords = vector4(-54.73, -1096.79, 26.27, 352.1),
                defaultVehicle = 'schafter2',
                chosenVehicle = 'schafter2'
            },
            [3] = {
                coords = vector4(-47.37, -1092.25, 26.27, 233.61),
                defaultVehicle = 'coquette',
                chosenVehicle = 'coquette'
            },
            [4] = {
                coords = vector4(-42.35, -1101.0, 26.27, 12.83),
                defaultVehicle = 'vigero',
                chosenVehicle = 'vigero'
            },
            [5] = {
                coords = vector4(-37.2, -1093.08, 26.27, 70.01),
                defaultVehicle = 'rhapsody',
                chosenVehicle = 'rhapsody'
            },
            [6] = {
                coords = vector4(-48.58, -1101.31, 26.27, 275.3),
                defaultVehicle = 'bati',
                chosenVehicle = 'bati'
            },
            [7] = {
                coords = vector4(-47.96, -1099.5, 26.27, 278.16),
                defaultVehicle = 'bati',
                chosenVehicle = 'bati'
            },
            [8] = {
                coords = vector4(-47.25, -1097.71, 26.27, 283.63),
                defaultVehicle = 'bati',
                chosenVehicle = 'bati'
            }
        },
    ...
    ['tuner'] = {
        ...
        ['Job'] = 'none', -- Name of job or none
        ['ShopLabel'] = 'Import Vehicle Shop', -- Blip name
        ['showBlip'] = true, -- true or false
        ['blipSprite'] = 326, -- Blip sprite
        ['blipColor'] = 3, -- Blip color
        ['TestDriveTimeLimit'] = 0.5, -- Time in minutes until the vehicle gets deleted
        ...
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(150.94, -3043.11, 6.55, 27.34), -- where the vehicle will spawn on display
                defaultVehicle = '22m5', -- Default display vehicle
                chosenVehicle = '22m5', -- Same as default but is dynamically changed when swapping vehicles
            },
            [2] = {
                coords = vector4(145.47, -3046.35, 6.54, 32.4),
                defaultVehicle = 'gtr',
                chosenVehicle = 'gtr',
            },
            [3] = {
                coords = vector4(140.08, -3047.02, 6.37, 341.69),
                defaultVehicle = 'r33',
                chosenVehicle = 'r33',
            },
        },
